...
import { getFirestore, doc, getDoc, setDoc, serverTimestamp, deleteField } from 'https://www.gstatic.com/firebasejs/12.16.0/firebase-firestore.js';
import { firebaseConfig, SITE_ID } from '../firebase-config.js';
import { DEFAULT_DATA } from '../site-data.js';

window.__FGFB = { initializeApp, getAuth, onAuthStateChanged, signInWithEmailAndPassword, signOut, getFirestore, doc, getDoc, setDoc, serverTimestamp, deleteField, firebaseConfig, SITE_ID, DEFAULT_DATA };
